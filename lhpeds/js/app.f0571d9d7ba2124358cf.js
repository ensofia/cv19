  ...
  methods: {
    ...
    sendEmail() {
      ...
      self.attachedAnswers.forEach(obj => {
        var sendObj = {};
        Object.keys(obj).forEach(element => {
          if (!element.includes("Started") && !element.includes("age65") && !element.includes("lung") && !element.includes("last_name") && !element.includes("traveled") && !element.includes("retake") && !element.includes("index") && !element.includes("date_created") && !element.includes("self_or_not") && !element.includes("user_had_nausea_vomiting") && !element.includes("pdf") && !element.includes("started")) {
            var x = "";
            if (element.includes("user_")) {
              var y = element.split("_");
              if (y.length > 2) {
...
//# sourceMappingURL=app.f0571d9d7ba2124358cf.js.map