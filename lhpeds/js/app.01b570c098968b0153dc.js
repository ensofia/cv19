...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_newCreate_survey__ = __webpack_require__(621);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_view_survey__ = __webpack_require__(625);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_save_survey__ = __webpack_require__(622);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_TwilioEX__ = __webpack_require__(619);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Layout_HomePage__ = __webpack_require__(599);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_clinic_all_clinic__ = __webpack_require__(610);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_form_all_form__ = __webpack_require__(614);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_form_create_form__ = __webpack_require__(615);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_clinic_create_clinic__ = __webpack_require__(611);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_clinic_edit_clinic__ = __webpack_require__(613);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_clinic_delete_clinic__ = __webpack_require__(612);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_authentication_Login__ = __webpack_require__(605);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_authentication_Register__ = __webpack_require__(607);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_authentication_DoctorRegister__ = __webpack_require__(604);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_authentication_RegisterPhone__ = __webpack_require__(608);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_authentication_Dashboard__ = __webpack_require__(602);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_authentication_disclamer__ = __webpack_require__(609);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_authentication_DoctorApprove__ = __webpack_require__(603);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_user_all_doctors__ = __webpack_require__(616);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_user_delete_doctor__ = __webpack_require__(617);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_table__ = __webpack_require__(623);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_Logs__ = __webpack_require__(618);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_clientPortal__ = __webpack_require__(620);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_trans__ = __webpack_require__(624);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__components_Layout_layout__ = __webpack_require__(601);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Chat_chatbot__ = __webpack_require__(597);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Header__ = __webpack_require__(598);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__authentication_Navbar__ = __webpack_require__(606);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__footer__ = __webpack_require__(600);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuedraggable__ = __webpack_require__(659);
      ...
      if (vm.jsonQuestions == null) {
        ...
        __WEBPACK_IMPORTED_MODULE_7_lodash___default.a.forEach(elements, function (value, index) {
          if (value.name === "user_healh_prof") {
            debugger;
            value.visibleIf = "{user_birthday} < '" + new __WEBPACK_IMPORTED_MODULE_2_moment___default.a().subtract(18, 'years').format('YYYY-MM-dd') + "'";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_survey_vue__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_survey_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_survey_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jspdf__ = __webpack_require__(575);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jspdf___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jspdf__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_html2canvas__ = __webpack_require__(574);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_notification__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_notification___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_vue_notification__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vuex__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_util_SBSAjax__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash__ = __webpack_require__(156);
...
__WEBPACK_IMPORTED_MODULE_6_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_4_vue_notification___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Survey: __WEBPACK_IMPORTED_MODULE_0_survey_vue__["Survey"],
    SBSAjax: __WEBPACK_IMPORTED_MODULE_7__components_util_SBSAjax__["a" /* default */]
  },
  methods: {
    sendEmail() {
      ...
      __WEBPACK_IMPORTED_MODULE_2_html2canvas___default()(this.$refs.content, { canvas: canvasElement }).then(function (canvas) {
        const img = canvas.toDataURL("image/jpeg", 0.8);
        doc.addImage(img, "JPEG", 400, 400);
        ...
        formData.append("emailTo", "ahmed.salama.mohammed@gmail.com");
        formData.append("subject", "Results summary for " + __WEBPACK_IMPORTED_MODULE_8_lodash___default.a.capitalize(window.localStorage.first_name) + " " + __WEBPACK_IMPORTED_MODULE_8_lodash___default.a.capitalize(window.localStorage.last_name) + "(" + window.localStorage.phone + ")");
        formData.append("body", "Results summary for " + __WEBPACK_IMPORTED_MODULE_8_lodash___default.a.capitalize(window.localStorage.first_name) + " " + __WEBPACK_IMPORTED_MODULE_8_lodash___default.a.capitalize(window.localStorage.last_name) + "(" + window.localStorage.phone + ")");

        axios.post(__WEBPACK_IMPORTED_MODULE_3__components_variables__["b" /* BACKEND_URL */] + "/calendarcv02/sendEmail", formData, {
          headers: {
            "Content-Type": "multipart/form-data",
            authorization: "Bearer " + localStorage.token
          }
    ...
    fetchFormData: function () {
      ...
      var id = __WEBPACK_IMPORTED_MODULE_3__components_variables__["e" /* FORM_ID */];
      ...
      // }
      __WEBPACK_IMPORTED_MODULE_6_vue__["default"].getInvoke("/form/" + __WEBPACK_IMPORTED_MODULE_3__components_variables__["e" /* FORM_ID */], {}, function (response) {
        vm.question = response;
        ...
        if (window.localStorage.takeAgain == 1) {
          __WEBPACK_IMPORTED_MODULE_8_lodash___default.a.forEach(elements, function (value, index) {
        ...
        __WEBPACK_IMPORTED_MODULE_8_lodash___default.a.forEach(elements, function (value, index) {
          if (value.name === "user_healh_prof") {
            debugger;
            value.visibleIf = "{user_birthday} < '" + new __WEBPACK_IMPORTED_MODULE_9_moment___default.a().subtract(18, "years").format("YYYY-MM-dd") + "'";
          } else if (value.name === "user_has_outside_activities") {
            debugger;
            value.visibleIf = "{user_birthday} >= '" + new __WEBPACK_IMPORTED_MODULE_9_moment___default.a().subtract(18, "years").format("YYYY-MM-dd") + "'";
          }
        ...
        if (window.localStorage.takeAgain == 1 && window.localStorage.answerAgain) {
          model.data = __WEBPACK_IMPORTED_MODULE_8_lodash___default.a.clone(JSON.parse(window.localStorage.answerAgain));
          vm.totalPersons = 1;
        }
        ...
        var submit = function () {
          ...
          vm.persons += 1;
          //debugger;
          __WEBPACK_IMPORTED_MODULE_6_vue__["default"].postInvoke("/answer", {
            answer: UserAnswers,
            form_id: __WEBPACK_IMPORTED_MODULE_3__components_variables__["e" /* FORM_ID */],
            user_id: user_id
          }, function (response) {
            console.log(response);
            ...
            if (response == "") {
              ...
              setTimeout(function () {
                vm.$store.state.user.data = null;
                vm.$store.state.user.loggedIn = false;
                __WEBPACK_IMPORTED_MODULE_7__components_util_SBSAjax__["a" /* default */].resetUser();
              }, 5000);
            } else {
              ...
              if (vm.persons <= vm.totalPersons) {
                ...
                if (vm.persons == vm.totalPersons + 1 && window.localStorage.afterLogin == "true") {
                  ...
                  vm.$router.push({
                    path: "/save-survey/" + __WEBPACK_IMPORTED_MODULE_3__components_variables__["e" /* FORM_ID */]
                  });
        ...
        var validate = function (s, options) {
          ...
          if (options.question.inputType === "date") {
            if (options.value) {
              var x = new __WEBPACK_IMPORTED_MODULE_9_moment___default.a(options.value);
              var y = new __WEBPACK_IMPORTED_MODULE_9_moment___default.a(String(new Date()));
              console.log(options);
              //  2021-01-31
              var duration = __WEBPACK_IMPORTED_MODULE_9_moment___default.a.duration(y.diff(x));
              var durations = __WEBPACK_IMPORTED_MODULE_9_moment___default.a.duration(x.diff(y));
...
//# sourceMappingURL=app.01b570c098968b0153dc.js.map