...
/* harmony export (immutable) */ __webpack_exports__["i"] = EMAIL_TO;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    checkUserCanRegister: function () {
      ...
      const axios = __webpack_require__(27).default;
      if (this.notifications) this.notifications = [];
      window.localStorage.registerPhone = this.form.phone;
      if (this.form.phone) __WEBPACK_IMPORTED_MODULE_1_vue__["default"].postInvoke("/usercancall", {
        pin: vm.form.password,
        phone: vm.form.phone,
  ...
  methods: {
    sendMessage() {
      ...
      __WEBPACK_IMPORTED_MODULE_8_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_1__components_variables__["b" /* BACKEND_URL */] + "/calendarcv02/send_SMS_andLog", {
        smsbody: "When you arrive to your appointment, please remain in the car and call us, and we will let you know when to come in. Keep a mask on at all times, and we will open and close the doors for you, Thank you. From Lighthouse pediatrics",
        smsfrom: "+14084134555",
        smsto: window.localStorage.registerPhone
      }, {
        headers: {
          authorization: "Bearer " + localStorage.token
        }
    ...
    sendEmail() {
      ...
      self.attachedAnswers.forEach(obj => {
        var sendObj = {};
        Object.keys(obj).forEach(element => {
          if (!element.includes("Started") && !element.includes("age65") && !element.includes("lung") && !element.includes("traveled") && !element.includes("retake") && !element.includes("index") && !element.includes("date_created") && !element.includes("self_or_not") && !element.includes("user_had_nausea_vomiting") && !element.includes("pdf") && !element.includes("started")) {
            var x = "";
            if (element.includes("user_")) {
              var y = element.split("_");
              if (y.length > 2) {
      ...
      formData["emailTo"] = __WEBPACK_IMPORTED_MODULE_1__components_variables__["i" /* EMAIL_TO */];
      formData["filename"] = self.name + "(" + self.phone + ").xlsx";
...
//# sourceMappingURL=app.205af8ac3e341a92077a.js.map