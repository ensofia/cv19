  ...
  methods: {
    ...
    fetchAnswerData: function () {
      ...
      for (let index = 0; index < userAnswers.length; index++) {
        ...
        userAnswer.answer.user_birthday = new __WEBPACK_IMPORTED_MODULE_2_moment___default.a(String(userAnswer.answer.user_birthday)).format("MM-DD-YYYY");
  ...
  methods: {
    ...
    sendEmail() {
      ...
      self.attachedAnswers.forEach(obj => {
        ...
        sendObj["user_birthday"] = sendObj["user_birthday"] ? new __WEBPACK_IMPORTED_MODULE_7_moment___default.a(String(sendObj["user_birthday"])).format("MM/DD/YYYY") : sendObj["user_birthday"];
...
//# sourceMappingURL=app.d6f3527f85a9fb951ef7.js.map