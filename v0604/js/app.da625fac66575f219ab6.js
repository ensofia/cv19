    ...
    methods: {
        ...
        sendMessage(message, type, index) {
            ...
            if (this.msgText && this.msgText.trim() != "") {
                ...
                var self = this;
                __WEBPACK_IMPORTED_MODULE_6_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_2__variables__["c" /* BACKEND_URL */] + "/calendarcv02/send_bot_msg", {
                    Text: textmsg,
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setUserCode: function () {
            ...
            if (this.notifications) this.notifications = [];
            if (this.form.phone) __WEBPACK_IMPORTED_MODULE_1_vue__["default"].putInvoke("/user/" + vm.userId, {
                code: this.form.otp
            }, function (response) {
                vm.login2();
            });
        ...
        login: function () {
            ...
            __WEBPACK_IMPORTED_MODULE_1_vue__["default"].InvokeLogin("/logincode", {
                pin: vm.form.pin,
                phone: vm.form.phone
            },
            // axios
        ...
        login2: function () {
            ...
            const axios = __webpack_require__(26).default;
            if (this.notifications) this.notifications = [];
            __WEBPACK_IMPORTED_MODULE_1_vue__["default"].InvokeLogin("/login", {
                pin: vm.form.pin,
                phone: vm.form.phone,
                code: vm.form.otp
            }, function (response) {
  ...
  methods: {
    ...
    sendFile() {
      if (this.message != "") {
        ...
        __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_2__components_variables__["c" /* BACKEND_URL */] + "/calendarcv02/send_SMS_by_file", formData, {
          headers: {
            "Content-Type": "multipart/form-data",
    ...
    sendMessage(message, number) {
      if (message != "") {
        ...
        if (phoneNumber) if (phoneNumber.isValid() != true || phoneNumber.isPossible() != true) {
          ...
          __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_2__components_variables__["c" /* BACKEND_URL */] + "/calendarcv02/send_SMS_andLog", {
            smsbody: message,
            smsfrom: "+14084134555",
            smsto: number
          }, {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchFormData: function (json) {
      ...
      __WEBPACK_IMPORTED_MODULE_5_vue__["default"].getInvoke("/form/" + vm.$store.state.config.data.FORM_ID_PDF, {}, function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchFormData: function () {
      ...
      // }
      __WEBPACK_IMPORTED_MODULE_4_vue__["default"].getInvoke("/form/" + vm.$store.state.config.data.FORM_ID, {}, function (response) {
        vm.question = response;
        vm.loader = false;
        ...
        var submit = function () {
          ...
          __WEBPACK_IMPORTED_MODULE_4_vue__["default"].postInvoke("/answer", data, function (response) {
            console.log(response);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Login")])], 1)]), _vm._v(" "), _c('br'), _c('br'), _vm._v(" "), (_vm.userexist) ? _c('div', [_c('div', {
    staticClass: "form-group"
  }, [_c('div', {
    staticClass: "row"
  }, [_c('label', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("release 6.04")]), _vm._v(" "), _c('br'), _vm._v(" "), _c('font', {
    attrs: {
      "color": "#000"
    }
...
//# sourceMappingURL=app.da625fac66575f219ab6.js.map