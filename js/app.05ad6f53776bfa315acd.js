        ...
        vm.savePDF = function () {
          ...
          surveyPDF.onRenderQuestion.add(function (survey, options) {
            ...
            if (options.question.name === "name") {
              ...
              htmlQuestion.html = '<font color="black" face="Verdana, Geneva, sans-serif" size="+1"><font face="Arial" color="black"><strong style="text-decoration: underline;">COVID 19 self-checker based on CDC guidelines<br><p style="text-align: center;"><font color="#2B60DE"><strong>User Phone #:' + vm.user.data.phone + '<br> User DoB:' + birthDate.getDay() + '/' + birthDate.getMonth() + '<strong></font></p>';
...
//# sourceMappingURL=app.05ad6f53776bfa315acd.js.map