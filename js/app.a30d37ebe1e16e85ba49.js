    ...
    fetchFormData: function () {
      ...
      this.$http.get(__WEBPACK_IMPORTED_MODULE_2__components_variables__["a" /* URL */] + "/form/" + __WEBPACK_IMPORTED_MODULE_2__components_variables__["b" /* FORM_ID */], {
        ...
        vm.savePDF = function () {
          ...
          vm.pdfs = [];
          if (user_has_cough.value || user_has_fever.value || user_has_short_breath.value || user_has_diarrhea.value || user_has_nausea_vomiting.value) {
            vm.pdfs.push({
...
//# sourceMappingURL=app.a30d37ebe1e16e85ba49.js.map