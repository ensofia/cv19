...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_newCreate_survey__ = __webpack_require__(410);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_view_survey__ = __webpack_require__(412);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_save_survey__ = __webpack_require__(411);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_TwilioEX__ = __webpack_require__(409);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Layout_HomePage__ = __webpack_require__(391);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_clinic_all_clinic__ = __webpack_require__(401);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_form_all_form__ = __webpack_require__(405);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_form_create_form__ = __webpack_require__(406);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_clinic_create_clinic__ = __webpack_require__(402);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_clinic_edit_clinic__ = __webpack_require__(404);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_clinic_delete_clinic__ = __webpack_require__(403);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_authentication_Login__ = __webpack_require__(396);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_authentication_Register__ = __webpack_require__(398);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_authentication_RegisterPhone__ = __webpack_require__(399);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_authentication_Dashboard__ = __webpack_require__(394);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_authentication_disclamer__ = __webpack_require__(400);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_authentication_DoctorApprove__ = __webpack_require__(395);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_user_all_doctors__ = __webpack_require__(407);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_user_delete_doctor__ = __webpack_require__(408);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_Layout_layout__ = __webpack_require__(393);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Header__ = __webpack_require__(390);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__authentication_Navbar__ = __webpack_require__(397);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__footer__ = __webpack_require__(392);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_tel_input__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__variables__ = __webpack_require__(18);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    VueTelInput: __WEBPACK_IMPORTED_MODULE_2_vue_tel_input__["a" /* VueTelInput */]
  },
  validations: {
    form: {
      phone: {
        required: __WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators__["required"],
        minLength: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators__["minLength"])(10)
      },

      pin: { required: __WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators__["required"], integer: __WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators__["integer"], maxLength: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_vuelidate_lib_validators__["maxLength"])(4)
        // otp:{required}
      } }
  },
  data() {
  ...
  methods: {
    ...
    setUserCode: function () {
      ...
      let vm = this;
      const axios = __webpack_require__(41).default;

      if (this.notifications) this.notifications = [];
      if (this.form.phone) axios.put(__WEBPACK_IMPORTED_MODULE_3__variables__["a" /* URL */] + "/user/" + vm.userId, { code: this.form.otp }, {
    ...
    login: function () {
      ...
      const axios = __webpack_require__(41).default;
      if (this.notifications) this.notifications = [];
      axios.get(__WEBPACK_IMPORTED_MODULE_3__variables__["a" /* URL */] + "/logincode?pin=" + vm.form.pin + "&phone=" + vm.form.phone).then(response => {
        if (response.data) {
          ...
          alert("Wrong Phone or Pin, please try again ");
          // vm.$router.push({
          //   path: "/register"
          // });
        }
    ...
    login2: function () {
      ...
      const axios = __webpack_require__(41).default;
      if (this.notifications) this.notifications = [];
      axios.get(__WEBPACK_IMPORTED_MODULE_3__variables__["a" /* URL */] + "/login?pin=" + vm.form.pin + "&code=" + vm.form.otp + "&phone=" + vm.form.phone, {
        headers: { authorization: "Bearer " + localStorage.token }
      }).then(response => {
        if (response.data) {
          console.log(response);
          __WEBPACK_IMPORTED_MODULE_4__store__["a" /* default */].dispatch("fetchUser", {
            id: response.data.id,
          ...
          if (response.data.doctor == 0) {
            if (vm.$store.state.user.data.answer && vm.$store.state.user.data.answer != "") {
              vm.$router.push({
                path: "/save-survey/" + __WEBPACK_IMPORTED_MODULE_3__variables__["b" /* FORM_ID */]
              });
            } else {
              vm.$router.push({ path: "/view-survey/" + __WEBPACK_IMPORTED_MODULE_3__variables__["b" /* FORM_ID */] });
            }
          } else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_firebase__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuejs_datepicker__ = __webpack_require__(441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__ = __webpack_require__(278);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_tel_input__ = __webpack_require__(276);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  validations: {
    form: {
      phone: {
        ...
        minLength: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["minLength"])(10)
      },
      ...
      zipCode: { required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"], integer: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["integer"], maxLength: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["maxLength"])(5) }
    }
  },
  data() {
    return {
  ...
  methods: {
    ...
    checkPin: function () {
      ...
      const axios = __webpack_require__(41).default;
      if (this.notifications) this.notifications = [];
      if (this.form.phone) axios.get(__WEBPACK_IMPORTED_MODULE_4__variables__["a" /* URL */] + "/check_pin?pin=" + vm.form.password + "&phone=" + vm.form.phone, {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuedraggable__ = __webpack_require__(440);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(386)))
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_variables__ = __webpack_require__(18);
//
//
//
//
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_survey_vue__ = __webpack_require__(275);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bootstrap_dist_css_bootstrap_css__ = __webpack_require__(369);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchFormData: function () {
      ...
      this.$http.get(__WEBPACK_IMPORTED_MODULE_2__components_variables__["a" /* URL */] + "/form/" + __WEBPACK_IMPORTED_MODULE_2__components_variables__["b" /* FORM_ID */], {
        headers: { 'authorization': 'Bearer ' + localStorage.token }
      }).then(response => {
        ...
        vm.savePDF = function () {
          ...
          surveyPDF.onRenderQuestion.add((survey, options) => {
            ...
            if (options.question.name === "name") {
              ...
              htmlQuestion.html = '<font color="black" face="Verdana, Geneva, sans-serif" size="+1"><font face="Arial" color="black"><strong style="text-decoration: underline;">COVID 19 self-checker based on CDC guidelines<br><p style="text-align: center;"><font color="#2B60DE"><strong>User Phone #:' + vm.user.data.phone + '<br> User DoB: ' + bdmonth + '/' + (bdday - 1) + '<strong></font></p>';
        ...
        var submit = function () {
          ...
          //   }
          // });
          this.$http.post(__WEBPACK_IMPORTED_MODULE_2__components_variables__["a" /* URL */] + "/answer", {
            answer: JSON.stringify(model.data),
            form_id: id,
            user_id: user_id
          }, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_survey_vue__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_survey_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_survey_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_variables__ = __webpack_require__(18);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.question.name_en))]), _vm._v(" "), (_vm.notComplete == 1) ? _c('h4', [_vm._v("Please answer these questions :")]) : _vm._e(), _vm._v(" "), _c('survey', {
    staticClass: "survey",
    attrs: {
      "survey": _vm.survey,
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "invalid-feedback"
  }, [(!_vm.$v.form.password.required) ? _c('span', [_vm._v("PIN is required")]) : _vm._e(), _vm._v(" "), (!_vm.$v.form.password.maxLength) ? _c('span', [_vm._v("PIN must be 4 digits sintegers only")]) : _vm._e(), _vm._v(" "), (!_vm.$v.form.password.integer) ? _c('span') : _vm._e()]) : _vm._e()])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_vm._m(7), _vm._v("\n               \n              "), _c('div', {
    staticClass: "form-group col col-9"
  }, [_c('input', {
    ...
    staticClass: "invalid-feedback"
  }, [(!_vm.$v.form.zipCode.required) ? _c('span', [_vm._v("ZipCode is required")]) : _vm._e(), _vm._v(" "), (!_vm.$v.form.zipCode.maxLength) ? _c('span', [_vm._v("ZipCode must be 5 digits integers only")]) : _vm._e(), _vm._v(" "), (!_vm.$v.form.zipCode.integer) ? _c('span') : _vm._e()]) : _vm._e()])]), _vm._v(" "), _vm._m(8), _vm._v(" "), _c('hr'), _vm._v(" "), _c('p', {
    staticClass: "btn btn-block mt-3 pointers",
    on: {
      "click": _vm.goToLogin
    }
  }, [_vm._v("Already a member? Log in")])])])])])]), _vm._v(" "), _c('br'), _vm._v(" "), _c('br')])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "service_area"
  }, [_c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Clinic Dashboard")])], 1), _vm._v(" "), _vm._m(2), _vm._v(" "), _vm._m(3), _vm._v(" "), _vm._m(4)])])])]), _vm._v(" "), _vm._m(5)])])])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "invalid-feedback"
  }, [(!_vm.$v.form.pin.required) ? _c('span', [_vm._v("PIN is required")]) : _vm._e(), _vm._v(" "), (!_vm.$v.form.pin.maxLength) ? _c('span', [_vm._v("PIN must be 4 digits integers")]) : _vm._e(), _vm._v(" "), (!_vm.$v.form.pin.integer) ? _c('span') : _vm._e()]) : _vm._e()])]), _vm._v(" "), _vm._m(3)]), _vm._v(" "), (_vm.userexist) ? _c('div', [_c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    attrs: {
      "for": "password"
  ...
  }, [_vm._v("Verify")]) : _vm._e()]) : _vm._e()])])])]), _vm._v(" "), _c('br'), _vm._v(" "), _c('br')])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "service_area"
  }, [_c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h1', [_vm._v("\n          This screening is for you, if you:\n        ")]), _vm._v(" "), _c('br'), _vm._v(" "), _vm._m(1), _vm._v(" "), _c('br'), _c('br'), _vm._v(" "), _vm._m(2), _vm._v(" "), _c('br'), _c('br'), _vm._v(" "), _c('br'), _c('br'), _vm._v(" "), _c('router-link', {
    staticClass: "boxed-btn3 large_margin",
    attrs: {
      "to": "/register"
    }
  ...
  return _c('div', {
    ...
    staticClass: "col col-9"
  }, [_c('p', [_c('strong', [_vm._v("Are")]), _vm._v(" "), _c('strong', [_vm._v(" 18 years or older")])]), _vm._v(" "), _c('p', [_vm._v("\nPlease use this site if you are 18 year or older, 3 different people may register with the same mobile phone number, each with a different PIN\n            ")])])])
}]}
...
//# sourceMappingURL=app.0a8c69c11c4534fc517d.js.map