...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__ = __webpack_require__(447);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  validations: {
    form: {
      ...
      zipCode: { required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"] }
    ...
    fetchFormData: function () {
      ...
      this.$http.get(__WEBPACK_IMPORTED_MODULE_2__components_variables__["a" /* URL */] + "/form/" + __WEBPACK_IMPORTED_MODULE_2__components_variables__["b" /* FORM_ID */]).then(response => {
        ...
        vm.savePDF = function () {
          ...
          if (user_has_cough.value || user_has_fever.value || user_has_short_breath) {
            vm.pdfs.push({
              url: "https://cdn.jsdelivr.net/gh/ensofia/cv19/docs/10Things.pdf",
              name: "10Things.pdf"
            });
            vm.pdfs.push({
              url: "https://cdn.jsdelivr.net/gh/ensofia/cv19/docs/sick-with-2019-nCoV-fact-sheet.pdf",
              name: "sick-with-2019-nCoV-fact-sheet.pdf"
            });
            vm.pdfs.push({
              url: "https://cdn.jsdelivr.net/gh/ensofia/cv19/docs/03.16.20_coronavirus-guidance_8.5x11_315PM.pdf",
              name: "03.16.20_coronavirus-guidance_8.5x11_315PM.pdf"
            });
          } else {
            vm.pdfs.push({
              url: "https://cdn.jsdelivr.net/gh/ensofia/cv19/docs/stop-the-spread-of-germs.pdf",
              name: "stop-the-spread-of-germs.pdf"
            });
            vm.pdfs.push({
              url: "https://cdn.jsdelivr.net/gh/ensofia/cv19/docs/03.16.20_coronavirus-guidance_8.5x11_315PM.pdf",
              name: "03.16.20_coronavirus-guidance_8.5x11_315PM.pdf"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "invalid-feedback"
  }, [(!_vm.$v.form.zipCode.required) ? _c('span', [_vm._v("ZipCode is required")]) : _vm._e()]) : _vm._e()])]), _vm._v(" "), _vm._m(8), _vm._v(" "), _c('hr'), _vm._v(" "), _c('p', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })])]), _vm._v(" "), _vm._m(4)])])])])]), _vm._v(" "), _c('br'), _vm._v(" "), _c('br')])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "service_area"
  }, [_c('div', {
...
//# sourceMappingURL=app.58dbb8ec0facda6e70db.js.map