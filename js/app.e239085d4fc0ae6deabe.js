        ...
        vm.savePDF = function () {
          ...
          surveyPDF.onRenderQuestion.add((survey, options) => {
            ...
            if (options.question.name === "name") {
              ...
              htmlQuestion.html = '<font color="black" face="Verdana, Geneva, sans-serif" size="+1"><font face="Arial" color="black"><strong style="text-decoration: underline;">COVID 19 self-checker based on CDC guidelines<br><p style="text-align: center;"><font color="#2B60DE"><strong>User Phone #:' + vm.user.data.phone + '<br> User DoB:' + birthDate.getDate() + '/' + (birthDate.getMonth() + 1).toString() + '<strong></font></p>';
...
//# sourceMappingURL=app.e239085d4fc0ae6deabe.js.map