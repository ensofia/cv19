...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    login2: function () {
      ...
      const axios = __webpack_require__(47).default;
      if (this.notifications) this.notifications = [];
      axios.get(__WEBPACK_IMPORTED_MODULE_2__variables__["a" /* URL */] + "/login?pin=" + vm.form.pin + "&code=" + vm.form.otp + "&phone=" + vm.form.phone, {
        headers: { 'authorization': 'Bearer ' + localStorage.token }
      }).then(response => {
        if (response.data) {
          console.log(response);
        ...
        vm.savePDF = function () {
          ...
          surveyPDF.onRenderQuestion.add((survey, options) => {
            ...
            if (options.question.name === "name") {
              var htmlQuestion = __WEBPACK_IMPORTED_MODULE_0_survey_vue__["QuestionFactory"].Instance.createQuestion("html", "html_question");
              debugger;
              htmlQuestion.html = '<font color="black" face="Verdana, Geneva, sans-serif" size="+1"><font face="Arial" color="black"><strong style="text-decoration: underline;">COVID 19 self-checker based on CDC guidelines<br><p style="text-align: center;"><font color="#2B60DE"><strong>User Phone #:' + vm.user.data.phone + '<br> User DoB: ' + (birthDate.getMonth() + 1 < 10 ? '0' + (birthDate.getMonth() + 1).toString() : (birthDate.getMonth() + 1).toString()) + '/' + (birthDate.getDate() < 10 ? '0' + birthDate.getDate().toString() : birthDate.getDate().toString()) + '<strong></font></p>';
...
//# sourceMappingURL=app.2e939e7ccba2680cd679.js.map