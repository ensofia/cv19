...
/* harmony export (immutable) */ __webpack_exports__["c"] = BACKEND_URL;
...
const request = callBAck => {
    ...
    try {
        __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */].state.config.loading = true;
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(BACKEND_URL + "/calendarcv02/get_configurations").then(function (response) {
            const jsonS = response.data;
            var temp_config = {};
            jsonS.forEach(element => {
                temp_config[element.item_name] = element.item_value;
            });
            __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */].dispatch("fetchConfig", temp_config);
            console.log(jsonS);
            if (callBAck) callBAck();
        });

        // const response = await fetch('https://stag.cv19.app:8449', {
        //     method: 'post'
        // });
        ...
        //     temp_config[element.item_name] = element.item_value
        // });
        // store.dispatch("fetchConfig", temp_config);
        // 
        // console.log(jsonS);
        // if (callBAck) callBAck()
    } catch (e) {
...
// export const FORM_ID_PDF = "3"
// export const HOUSE_HOLD_NUMBERLHPED = "10"
// export const HOUSE_HOLD_NUMBER = "3"
// export const HOURS_LIMIT = 24
// export const YEARS = 18
// export const EMAIL_TO = "lhcv19app@gmail.com"
// export const EMAIL_TO_STAGE = "rashmi@ensofia.com"
// export const MESSAGE = "When you arrive to your appointment, please remain in the car and call us, and we will let you know when to come in. Keep a mask on at all times, and we will open and close the doors for you, Thank you. From Lighthouse pediatrics"
// export const MESSAGE_ARABIC = "عندما تصل إلى موعدك ، يرجى البقاء في السيارة والاتصال بنا ، وسنخبرك بموعد دخولك. احتفظ بقناع في جميع الأوقات ، وسنفتح لك الأبواب ونغلقها ، شكرًا لك. من طب الأطفال المنارة"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_newCreate_survey__ = __webpack_require__(737);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_view_survey__ = __webpack_require__(740);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_save_survey__ = __webpack_require__(738);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_TwilioEX__ = __webpack_require__(735);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue_resource__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Layout_HomePage__ = __webpack_require__(715);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_clinic_all_clinic__ = __webpack_require__(726);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_form_all_form__ = __webpack_require__(730);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_form_create_form__ = __webpack_require__(731);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_clinic_create_clinic__ = __webpack_require__(727);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_clinic_edit_clinic__ = __webpack_require__(729);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_clinic_delete_clinic__ = __webpack_require__(728);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_authentication_Login__ = __webpack_require__(721);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_authentication_Register__ = __webpack_require__(723);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_authentication_DoctorRegister__ = __webpack_require__(720);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_authentication_RegisterPhone__ = __webpack_require__(724);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_authentication_Dashboard__ = __webpack_require__(718);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_authentication_disclamer__ = __webpack_require__(725);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_authentication_DoctorApprove__ = __webpack_require__(719);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_user_all_doctors__ = __webpack_require__(732);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_user_delete_doctor__ = __webpack_require__(733);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_table__ = __webpack_require__(739);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_Logs__ = __webpack_require__(734);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_clientPortal__ = __webpack_require__(736);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__components_Layout_layout__ = __webpack_require__(717);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__variables__ = __webpack_require__(15);
...
const SBSAjax = {
  ...
  reloadpage() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0_vue__["default"].__BaseRootURL === "") {
      if (window.location.port !== "" && window.location.port !== 84 && window.location.port !== 443) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_vue__["default"].__BaseServiceRootURL = __WEBPACK_IMPORTED_MODULE_2__variables__["c" /* BACKEND_URL */];
  ...
  install(Vue, options) {
    ...
    Vue.refreshToken = (operationName, obj, method, callBackfn, head) => {

      var operationNameRef = operationName;
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(Vue.__BaseServiceRootURL + "/app/refresh", {}, {
        headers: {
        ...
        if (response && response.data) {
          ...
          switch (method) {
            case "put":
              ...
              break;
            case "post":
              Vue.postInvoke(operationName, obj, callBackfn, head);
              break;
            case "get":
        ...
        if (error.response.status == 401) {
          ...
          alert("Due to inactivity you are logged out, please log in again ");
          localStorage.clear();
          window.location.href = "/login";
        }
      });
    ...
    Vue.postInvoke = (operationName, obj, callBackfn, head = null) => {
      this.logoutAfterTime();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bootstrap_dist_css_bootstrap_min_css__ = __webpack_require__(375);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap_vue_dist_bootstrap_vue_css__ = __webpack_require__(121);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted() {
    window.localStorage.URL = __WEBPACK_IMPORTED_MODULE_1__components_variables__["a" /* URL */];
    if (!this.$store.state.config.loading && this.$store.state.config.data == null) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__components_variables__["b" /* request */])();
    }
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuejs_datepicker__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_loading_button__ = __webpack_require__(82);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    VueLoadingButton: __WEBPACK_IMPORTED_MODULE_4_vue_loading_button__["a" /* default */]
  },
  data() {
    return {
      // date: "",
      ...
      context: {
        ...
        backend_url: __WEBPACK_IMPORTED_MODULE_2__variables__["c" /* BACKEND_URL */]
      },
      isChatOpenChat: true,
  ...
  mounted() {
    if (!this.$store.state.config.loading && this.$store.state.config.data == null) {
      this.$store.state.config.loading = true;
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__variables__["b" /* request */])(this.firstAction);
    } else {
      this.firstAction();
    }
  },
  methods: {
    ...
    firstAction() {
      ...
      this.context["household_number"] = this.$store.state.config.data.HOUSE_HOLD_NUMBER;
    ...
    GoogleWrite(fileReader) {
      ...
      if (window.fileReader.readyState == 2) {
        ...
        __WEBPACK_IMPORTED_MODULE_6_axios___default.a.post(googleCloudSpeechUrl, conf, {
          headers: {
    ...
    googleTTS(txt) {
      ...
      var self = this;
      __WEBPACK_IMPORTED_MODULE_6_axios___default.a.post("https://texttospeech.googleapis.com/v1/text:synthesize", {
        input: {
          text: txt
        },
        voice: {
    ...
    sendMessage(message, type, index) {
      ...
      if (type == "date" || type == "birthdate") {
        if (message && message != "true" && message != "false") {
          this.msgText = __WEBPACK_IMPORTED_MODULE_5_moment___default()(message).format("MM-DD-YYYY");
        }
      }
      ...
      if (this.msgText && this.msgText.trim() != "") {
        ...
        var self = this;
        ;
        __WEBPACK_IMPORTED_MODULE_0_vue__["default"].postInvoke("/calendarcv02/send_bot_msg", {
          Text: textmsg,
          ...
          var txtSpeak = "";
          var textSpeak = "";
          for (var t in response.responseData.output.text) {
            if (response.responseData.output.text[t] != "") {
              txtSpeak += self.stripHtml(response.responseData.output.text[t]) + " " + "<br>";
              textSpeak += self.sprit(response.responseData.output.text[t]);
              // if (
          ...
          self.messageList.push({
            ...
            type: response.responseData.context.question_type
          });
          self.context = response.responseData.context;

          console.log(response);
          if (response.responseData.context.end_survey == true) {
            // ;
            self.endDialog = true;
            ...
            self.context = {
              timezone: Intl.DateTimeFormat().resolvedOptions().timeZone,
              backend_url: __WEBPACK_IMPORTED_MODULE_2__variables__["c" /* BACKEND_URL */],
              household_number: self.$store.state.config.data.HOUSE_HOLD_NUMBER
            };
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__variables_js__ = __webpack_require__(15);
//
//
//
//
...
function fitWidths() {
  if ($(window).width() < 1024) {
    $(".arrowCls").addClass("col-12");
    $(".arrowCls").removeClass("col-3");
    $(".arrowCls").removeClass("col-4");
  } else {
    if ($(window).width() == 1024) {
      $(".arrowCls").addClass("col-4");
      $(".arrowCls").removeClass("col-3");
      $(".arrowCls").removeClass("col-12");
    } else {
      $(".arrowCls").addClass("col-3");
      $(".arrowCls").removeClass("col-12");
      $(".arrowCls").removeClass("col-4");
    }
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Chat_chatbot__ = __webpack_require__(713);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Header__ = __webpack_require__(714);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__authentication_Navbar__ = __webpack_require__(722);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__footer__ = __webpack_require__(716);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_loaders__ = __webpack_require__(525);
//
//
//
//
...
__WEBPACK_IMPORTED_MODULE_3_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_4_vue_loaders__["a" /* default */]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    showloader(isloadershow) {
      this.loader = isloadershow;
    }
  },
  created() {

    window.__showloader = this.showloader;
  },
  components: {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_firebase__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuejs_datepicker__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuelidate_lib_validators__ = __webpack_require__(195);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_notification__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_tel_input__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__store__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_survey_vue__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_vue_loading_button__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__util_SBSAjax_js__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_libphonenumber_js__ = __webpack_require__(117);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted() {
    ...
    this.maxHouseHoldNumber = this.$store.state.config.data.HOUSE_HOLD_NUMBER;
  },
  methods: {
    setDate(date) {
    ...
    checkUserCanRegister: function () {
      ...
      const axios = __webpack_require__(31).default;
      if (this.notifications) this.notifications = [];
      if (this.form.phone) __WEBPACK_IMPORTED_MODULE_1_vue__["default"].postInvoke("/app/usercancall", {
    ...
    addUser: function () {
      ...
      const axios = __webpack_require__(31).default;
      if (this.notifications) this.notifications = [];
      if (this.form.phone) __WEBPACK_IMPORTED_MODULE_1_vue__["default"].postInvoke("/app/user", {
        ...
        if (vm.form.doctor == 0) vm.$router.push({
          path: "/view-survey/" + vm.$store.state.config.data.FORM_ID
        });else vm.$router.push({
          path: "/doctorapprove"
        });
      });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_SBSAjax_js__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuelidate_lib_validators__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuelidate_lib_validators___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vuelidate_lib_validators__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_notification__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_notification___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_vue_notification__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_tel_input__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__util_SBSAjax__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__store__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vue_loading_button__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_libphonenumber_js__ = __webpack_require__(117);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    verifyOtp() {
      ...
      } else if (this.form.otp == "" || this.form.otp.length != 6) {
        this.isLoadingVerify = false;
        this.$notify({
          type: "error",

          title: "Important message",
          text: "Invalid Or Empty OTP Format !"
        });
      } else {
        //
        let vm = this;
    ...
    setUserCode: function () {
      ...
      if (this.notifications) this.notifications = [];
      if (this.form.phone) __WEBPACK_IMPORTED_MODULE_1_vue__["default"].putInvoke("/app/user/" + vm.userId, {
        code: this.form.otp
      }, function (response) {
        vm.login2();
      });
    ...
    login: function () {
      ...
      __WEBPACK_IMPORTED_MODULE_1_vue__["default"].InvokeLogin("/app/logincode", {
        pin: vm.form.pin,
        phone: vm.form.phone
      },
      // axios
    ...
    login2: function () {
      ...
      const axios = __webpack_require__(31).default;
      if (this.notifications) this.notifications = [];
      __WEBPACK_IMPORTED_MODULE_1_vue__["default"].InvokeLogin("/app/login", {
        pin: vm.form.pin,
        phone: vm.form.phone,
        code: vm.form.otp
      }, function (response) {
        if (response.data != "") {
          ...
          if (response.data.doctor == 0) {
            ...
            if (window.localStorage.answer && window.localStorage.answer != "" && JSON.parse(window.localStorage.answer).length >= window.localStorage.hous_hold) {
              vm.$router.push({
                path: "/save-survey/" + vm.$store.state.config.data.FORM_ID
              });
              //  vm.$router.push({
              //   path: "/all",
              // });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    googleTranslateElementInit() {
      if (google && google.translate && google.translate.TranslateElement && google.translate.TranslateElement.InlineLayout) {
        var currentLang = "en";
        if (window.localStorage.lang) {
          currentLang = window.localStorage.lang;
        }
        window.GLangs = "en,tr,es,ar,fr,de,el,hi,it,ja,ru";
        window.GTranslate = new google.translate.TranslateElement({
          pageLanguage: currentLang, // to be got from local storage
          includedLanguages: window.GLangs,
    ...
    langChanged() {
      var iframes = document.getElementsByClassName("goog-te-menu-frame");
      if (iframes && iframes.length == window.GLangs.split(",").length) {
        var langLinks = iframes[0].contentDocument.getElementsByClassName("goog-te-menu2-item");
        // var frame = document.getElementsByClassName('goog-te-banner-frame skiptranslate');
        // frame.style.visibility = "hidden";
        if (langLinks.length > 0) {
          for (var i = 0; i < langLinks.length; i++) {
            langLinks[i].addEventListener("click", function (e) {
              window.localStorage.lang = window.GTranslate.c;
              return true;
            });
          }
          return;
      ...
      setTimeout(this.langChanged, 1000);
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuejs_datepicker__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__node_modules_bootstrap_dist_css_bootstrap_min_css__ = __webpack_require__(375);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__node_modules_bootstrap_vue_dist_bootstrap_vue_css__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vuelidate_lib_validators__ = __webpack_require__(195);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_notification__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_vue_tel_input__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_moment__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__store__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_survey_vue__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_vue_loading_button__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__util_SBSAjax_js__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_libphonenumber_js__ = __webpack_require__(117);
//
//
//
//
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__variables_js__ = __webpack_require__(15);
//
//
//
//
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__notifications_vue__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__variables_js__ = __webpack_require__(15);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__notifications_vue__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__notifications_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__notifications_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__variables__ = __webpack_require__(15);
//
//
//
//
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuedraggable__ = __webpack_require__(773);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    approveDoctor: function (id, index) {
      ...
      if (this.notifications) this.notifications = [];
      __WEBPACK_IMPORTED_MODULE_1_vue__["default"].putInvoke("/app/user/" + id, { verify: "true" }, function (response) {
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bootstrap_vue__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_axios__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_notification__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_notification___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_vue_notification__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_tel_input__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_libphonenumber_js__ = __webpack_require__(117);
//
//
//
//
  ...
  methods: {
    ...
    sendFile() {
      if (this.message != "") {
        ...
        var self = this;
        __WEBPACK_IMPORTED_MODULE_0_vue__["default"].postInvoke("/calendarcv02/send_SMS_by_file", formData, function (response) {
          ;
          self.$notify({
            type: "success",
    ...
    sendMessage(message, number) {
      if (message != "") {
        ...
        if (phoneNumber) if (phoneNumber.isValid() != true || phoneNumber.isPossible() != true) {
          ...
          __WEBPACK_IMPORTED_MODULE_0_vue__["default"].postInvoke("/calendarcv02/send_SMS_andLog", {
            smsbody: message,
            smsfrom: "+14084134555",
            smsto: number
          }, function (response) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_notification__ = __webpack_require__(63);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_variables__ = __webpack_require__(15);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    saveMySurvey: function () {
      ...
      //   }
      // });
      this.$http.put(__WEBPACK_IMPORTED_MODULE_0__components_variables__["a" /* URL */] + "/form/" + vm.$store.state.config.data.FORM_ID_PDF, {
        questions: vm.surveyCreator.text
      }, {
        headers: {
    ...
    getForm: function (json) {
      ...
      var oldv = json;
      if (this.notifications) this.notifications = [];
      this.$http.get(__WEBPACK_IMPORTED_MODULE_0__components_variables__["a" /* URL */] + "/form/" + vm.$store.state.config.data.FORM_ID_PDF, {
        headers: {
          enctype: "multipart/form-data",
          authorization: "Bearer " + localStorage.token
        }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_survey_vue__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bootstrap_dist_css_bootstrap_css__ = __webpack_require__(196);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_loading_button__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vuex__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_util_SBSAjax__ = __webpack_require__(56);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
  ...
  methods: {
    ...
    retake: function (create_date, answerArray, index) {
      if (create_date != "") {
        ...
        var y = new __WEBPACK_IMPORTED_MODULE_2_moment___default.a();
        ...
        this.takeAgain = this.hours >= parseInt(this.$store.state.config.data.HOURS_LIMIT) ? true : false;
        ...
        return this.hours >= parseInt(this.$store.state.config.data.HOURS_LIMIT) ? "1" : "24 hours";
      }
    },
    ...
    takeItAgain: function () {
      ...
      this.$router.push({
        path: "/view-survey/" + this.$store.state.config.data.FORM_ID
      });
    },
    ...
    fetchAnswerData: function () {
      ...
      for (let index = 0; index < userAnswers.length; index++) {
        ...
        if (userAnswer.create_date) {
          userAnswer.answer.date_created = new __WEBPACK_IMPORTED_MODULE_2_moment___default.a(userAnswer.create_date).add(new Date().getTimezoneOffset() / 60, "hour").format("MM-DD-YYYY");
        } else {
          userAnswer.create_date = new __WEBPACK_IMPORTED_MODULE_2_moment___default.a();
          userAnswer.answer.date_created = new __WEBPACK_IMPORTED_MODULE_2_moment___default.a().format("MM-DD-YYYY");
        }
    ...
    fetchFormData: function (json) {
      ...
      __WEBPACK_IMPORTED_MODULE_5_vue__["default"].getInvoke("/app/form/" + vm.$store.state.config.data.FORM_ID_PDF, {}, function (response) {
      ...
      if (vm.jsonQuestions == null) {
        ...
        __WEBPACK_IMPORTED_MODULE_7_lodash___default.a.forEach(elements, function (value, index) {
          if (value.name === "user_healh_prof") {
            ;
            value.visibleIf = "{user_birthday} <= '" + //YYYY-MM-DD  2002-06-02
            new __WEBPACK_IMPORTED_MODULE_2_moment___default.a(json.date_created) //2020-06-02
            .subtract(parseInt(vm.$store.state.config.data.YEARS), "years") // 2002-06-02
            .format("YYYY-MM-DD") + "'";
          } else if (value.name === "user_has_outside_activities") {
            ;

            value.visibleIf = "{user_birthday} > '" + new __WEBPACK_IMPORTED_MODULE_2_moment___default.a(json.date_created).subtract(parseInt(vm.$store.state.config.data.YEARS), "years").format("YYYY-MM-DD") + "'";
          }
        });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bootstrap_vue__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue_loaders__ = __webpack_require__(525);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_notification__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_notification___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_vue_notification__);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchUserData: function () {
      var self = this;
      __WEBPACK_IMPORTED_MODULE_1_vue__["default"].getInvoke("/app/user", {}, function (response) {
          ...
          if (user.answers && user.answers.length > 0) {
            for (var i = 0; i < user.answers.length; i++) {
              if (user.answers[i].answer.user_birthday) {
                // var date = new Date(user.answers[i].answer.user_birthday)
                //   .toISOString()
                //   .slice(0, 10);
                // var today = new Date();
                // var birthDate = new Date(date);
                ...
                // }
                //
                var x = new __WEBPACK_IMPORTED_MODULE_5_moment___default.a(String(user.answers[i].answer.user_birthday));
                var y = new __WEBPACK_IMPORTED_MODULE_5_moment___default.a(String(new Date()));
                var duration = __WEBPACK_IMPORTED_MODULE_5_moment___default.a.duration(y.diff(x));
                var age = Math.abs(parseInt("" + duration.as("year")));
                user.answers[i].birthday = age;
              } else {
                user.answers[i].birthday = "";
              }
              user.answers[i].phone = user.phone;
              user.answers[i].answer_date = new __WEBPACK_IMPORTED_MODULE_5_moment___default.a(user.answers[i].create_date).add(new Date().getTimezoneOffset() / 60, "hour").format("MM-DD-YYYY");
    ...
    fetchFormDatas() {
      __WEBPACK_IMPORTED_MODULE_1_vue__["default"].Invoke("/app/answer", {}, "get", function (response) {
        this.forms = response.body;
    ...
    sendMessage(message, number) {
      var self = this;
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_3__components_variables__["c" /* BACKEND_URL */] + "/calendarcv02/send_SMS_andLog", {
        smsbody: message,
        smsfrom: "+14084134555",
        smsto: number
      }, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_survey_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_survey_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_notification__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_util_SBSAjax__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash__ = __webpack_require__(193);
...
var myCss = {
  navigationButton: "button btn-lg col-sm-2 col-md-2 col-xl-4"
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    sendMessageAndEmail() {
      if (this.$store.state.config.data.SEND_EMAIL === "1") {
        this.sendEmail(this.$store.state.config.data.EMAIL_TO);
      }
      if (this.$store.state.config.data.SEND_SMS === "1") {
        this.sendMessage();
      }
    },
    sendMessage() {
      var self = this;
      __WEBPACK_IMPORTED_MODULE_8_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_1__components_variables__["c" /* BACKEND_URL */] + "/calendarcv02/send_SMS_andLog", {
        smsbody: self.$store.state.config.data.MESSAGE,
        smsfrom: "+14084134555",
    ...
    sendEmail(email) {
      ...
      self.attachedAnswers.forEach(obj => {
        sendAnswers.push(obj.user_birthday);

        // Object.keys(obj).forEach(element => {
        //   if (
        //     !element.includes("Started") &&
        //     !element.includes("age65") &&
        //     !element.includes("lung") &&
        //     !element.includes("last_name") &&
        //     !element.includes("traveled") &&
        //     !element.includes("retake") &&
        //     !element.includes("index") &&
        //     !element.includes("date_created") &&
        //     !element.includes("self_or_not") &&
        //     !element.includes("user_had_nausea_vomiting") &&
        //     !element.includes("pdf") &&
        //     !element.includes("started") &&
        //     !element.includes("relation-Comment")
        //   ) {
        //     var x = "";
        //     if (element.includes("user_")) {
        //       var y = element.split("_");
        //       if (y.length > 2) {
        //         y[3]
        //           ? (x = _.capitalize(y[2]) + " " + _.capitalize(y[3]))
        //           : (x = _.capitalize(y[2]));
        //       } else {
        //         x = _.capitalize(y[1]);
        //       }
        ...
        //         x = "Name";
        //       } else {
        //         x = _.capitalize(element);
        //       }
        //     }
        //     sendObj[x] = obj[element]
        //       ? obj[element] == true
        //         ? "Yes"
        //         : obj[element]
        //       : "No";
        ...
        // });
        //  ;
        // sendObj["Birthday"] = sendObj["Birthday"]
        //   ? new moment(String(sendObj["Birthday"])).format("MM/DD/YYYY")
        //   : sendObj["Birthday"];
      });

      var formData = {};
      formData["birthdays"] = sendAnswers;
      formData["userID"] = window.localStorage.userId;
      __WEBPACK_IMPORTED_MODULE_8_axios___default.a.post(__WEBPACK_IMPORTED_MODULE_1__components_variables__["c" /* BACKEND_URL */] + "/calendarcv02/send_survey_email", formData, {
        headers: {
          "Content-Type": "application/json",
          authorization: "Bearer " + localStorage.token
        }
    ...
    fetchFormData: function () {
      ...
      var id = this.$store.state.config.data.FORM_ID;
      var user_id = window.localStorage.userId;
      this.totalPersons = parseInt(window.localStorage.hous_hold);
      if (window.localStorage.afterLogin == "true" && window.localStorage.answer != null && window.localStorage.answer != "") {
        var answerListLogin = JSON.parse(window.localStorage.answer);
        this.totalPersons = this.totalPersons - answerListLogin.length;
        answerListLogin.forEach(element => {
          this.answersAfterLogin.push(element);
          this.attachedAnswers.push(element.answer.user_birthday);
          if (element.answer.relation === "Spouse") {
            this.spouse = true;
          }
          if (element.answer.relation === "Self") {
            this.self = true;
          }
        });

        this.message = "Our database shows you have " + window.localStorage.hous_hold + " members in your household,but you have answered only for the " + this.attachedAnswers.length + " members whose birthdays are [" + __WEBPACK_IMPORTED_MODULE_6_lodash___default.a.toString(this.attachedAnswers) + "] and You need to answer for remaining " + this.totalPersons + " members";
      } else {
        if (window.localStorage.afterLogin == "true") {
          this.message = "Our database shows you have " + window.localStorage.hous_hold + " members in your household,Please you need to answer the survey first";
        } else if (window.localStorage.answer != null && window.localStorage.answer != "") {
          this.message = "Note: if everythings goes like yestrday so you can click submit directly ";
        }
      }
      var vm = this;
      ...
      // }
      __WEBPACK_IMPORTED_MODULE_4_vue__["default"].getInvoke("/app/form/" + vm.$store.state.config.data.FORM_ID, {}, function (response) {
        vm.question = response;
        vm.loader = false;
        ...
        var loginUrl = "<a href=" + vm.$store.state.config.data.LOGIN_URL + ">";
        questions.completedHtml = "Thank you for taking the time to complete this self assessment. Please go to " + loginUrl + '<strong style="text-decoration: underline;"> log in</strong></a> with your phone number and PIN, we will send you a verification code. Enter the verification code to complete the log in and access your personalized report.';
        if (window.localStorage.takeAgain == 1) {
          questions.completedHtml = '<div class="loader"></div>';
        ...
        __WEBPACK_IMPORTED_MODULE_6_lodash___default.a.forEach(elements, function (value, index) {
          if (value.name === "user_healh_prof") {
            ...
            value.visibleIf = "{user_birthday} <= '" + new __WEBPACK_IMPORTED_MODULE_7_moment___default.a().subtract(parseInt(vm.$store.state.config.data.YEARS), "years").format("YYYY-MM-DD") + "'";
          } else if (value.name === "user_has_outside_activities") {
            ;
        ...
        var submit = function () {
          ...
          var data = {
            answer: UserAnswers,
            form_id: vm.$store.state.config.data.FORM_ID,
            user_id: user_id
          };
          ;
          if (vm.persons == vm.totalPersons) {
            vm.attachedAnswers.push(UserAnswers.user_birthday);
            data["birthdays"] = vm.attachedAnswers;
          } else {
            vm.attachedAnswers.push(UserAnswers.user_birthday);
          }
          vm.persons += 1;

          __WEBPACK_IMPORTED_MODULE_4_vue__["default"].postInvoke("/app/answer", data, function (response) {
            console.log(response);
        ...
        var validate = function (s, options) {
          ...
          if (options.question.inputType === "date") {
            if (options.value) {
              ...
              ;
              if (options.name == "user_birthday" && __WEBPACK_IMPORTED_MODULE_6_lodash___default.a.indexOf(vm.attachedAnswers, options.value) != -1) {
                options.error = "This date of birth is already registered,please select another one.";
              }
              if (x.isAfter(y)) {
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__App__ = __webpack_require__(529);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__App___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__App__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__router__ = __webpack_require__(528);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_resource__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_bootstrap_vue__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_firebase__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__store__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_variables__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_vuelidate__ = __webpack_require__(530);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_util_SBSAjax__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_bootstrap_dist_css_bootstrap_css__ = __webpack_require__(196);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_bootstrap_vue_dist_bootstrap_vue_css__ = __webpack_require__(121);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "login-module col-xl-6 col-md-8 col-sm-12"
  }, [_c('div', {
    ...
    staticClass: "doctors_title mb-55 login_header"
    ...
    staticClass: "deletcol_Padding",
    attrs: {
      "for": "phone"
    }
  }, [_vm._v("Phone")]), _vm._v(" "), _c('vue-tel-input', _vm._b({
    staticClass: "form-control phone_input_direction",
    on: {
  ...
  }, 'vue-tel-input', _vm.bindProps, false)), _vm._v(" "), (_vm.showValidation) ? _c('div', {
    staticClass: "showField col-10"
    ...
    staticClass: "invalid-feedback col-10"
    ...
    staticClass: "boxed-btn3 pull-right",
    attrs: {
  ...
  }, [_vm._v("Login")])], 1)]), _vm._v(" "), _c('br'), _vm._v(" "), _c('br'), _vm._v(" "), (_vm.userexist) ? _c('div', [_c('div', {
    staticClass: "form-group"
  }, [_c('div', {
    staticClass: "row"
  }, [_c('label', {
  ...
  })]), _vm._v(" "), _c('br'), _vm._v(" "), (!_vm.haveCode) ? _c('VueLoadingButton', {
    staticClass: "boxed-btn3 pull-right",
    attrs: {
  ...
  return _c('div', {
    ...
    staticClass: "row no-gutters deletcol_Padding"
  }, [_c('div', {
  ...
  }), _vm._v(" "), _c('p', [_vm._v("Complete the screening questionnaire")]), _vm._v(" "), _c('br'), _vm._v(" "), _c('br'), _vm._v(" "), _c('br'), _vm._v(" "), _c('br')])]), _vm._v(" "), _c('div', {
    staticClass: "col-xl-4 col-md-4"
  }, [_c('div', {
    staticClass: "single_service"
  }, [_c('img', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "form-control col-md-9 col-sm-9 phone_input_direction",
    attrs: {
    ...
    staticClass: "form-control col-md-9 col-sm-9",
    attrs: {
      "id": "first_name",
    ...
    staticClass: "form-group col-md-9 col-sm-9"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  return _c('div', {
    ...
    staticClass: "col-xl-4 col-md-4 col-sm-3"
  }, [_c('div', {
    staticClass: "single_service"
  }, [_c('img', {
    attrs: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "boxed-btn3 center_button",
    attrs: {
      "to": "/disclamer"
    }
  }, [_vm._v("Start Screening NOW")]), _vm._v("  \n                    "), (_vm.$store.state.showHotline) ? _c('strong', {
    staticClass: "or_class"
  }, [_vm._v("OR")]) : _vm._e(), _vm._v("\n                      \n                    "), (_vm.$store.state.showHotline) ? _c('a', {
    staticClass: "boxed-btn3 center_button",
    attrs: {
    ...
    staticClass: "row row justify-content-center"
  }, [_c('router-link', {
    staticClass: "boxed-btn3 center_button",
    attrs: {
      "to": "/disclamer"
  ...
  return _c('div', {
    ...
    staticClass: "pointerP"
  }, [_vm._v("Register, Keep your PIN")])])]), _vm._v(" "), _c('div', {
    staticClass: "arrowCls",
    attrs: {
      "id": "pointers2"
    }
    ...
    staticClass: "pointerP"
  }, [_vm._v("Take self assessment")])])]), _vm._v(" "), _c('div', {
    staticClass: "arrowCls",
    attrs: {
      "id": "pointers3"
    }
    ...
    staticClass: "pointerP"
  }, [_vm._v("Login, Get verification code")])])]), _vm._v(" "), _c('div', {
    staticClass: "arrowCls",
    attrs: {
      "id": "pointers4"
    }
    ...
    staticClass: "pointerP"
  }, [_vm._v("Download your report")])])])]), _vm._v(" "), _c('br'), _vm._v(" "), _c('br')])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "col-xl-4 col-md-4"
  }, [_c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [(_vm.message != null) ? _c('b-alert', {
    attrs: {
      "show": ""
    }
  }, [_vm._v(_vm._s(_vm.message))]) : _vm._e(), _vm._v(" "), _c('h1', {
    staticClass: "text-center"
  }, [_vm._v(_vm._s(_vm.question.name_en))]), _vm._v(" "), (_vm.notComplete == 1) ? _c('div', [(_vm.totalPersons != 1) ? _c('h1', {
    staticClass: "text-center"
  }, [_vm._v("Person: " + _vm._s(_vm.persons) + "/ " + _vm._s(_vm.totalPersons))]) : _vm._e()]) : _vm._e(), _vm._v(" "), (_vm.notComplete == 1) ? _c('h4', {
    staticStyle: {
      "padding-left": "10px"
    }
  }, [_vm._v("Please answer these questions :")]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "survey_class",
    attrs: {
      "id": "surveyElement"
    }
  }, [_c('survey', {
  ...
  })], 1)], 1)]) : _vm._e()]), _vm._v(" "), _c('br'), _vm._v(" "), _c('br')]), _vm._v(" "), _c('notifications', {
    attrs: {
      "position": "top center"
    }
  })], 1)
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.disable) ? _c('b-container', {
    ...
    staticClass: "mb-0 ulSelect padding_label",
    attrs: {
      "label": "Select Type",
      "label-cols-sm": "5",
      "label-cols-md": "4",
    ...
    staticClass: "inside"
  })])])])])], 1) : _vm._e()], 1), _vm._v(" "), (_vm.openNumber == true || _vm.openFile == true) ? _c('b-row', {
    staticClass: "top_padding"
  }, [_c('b-col', {
    staticClass: "my-1",
    attrs: {
      "lg": "6",
    ...
    staticClass: "form-control w-100 phone_input_direction",
    attrs: {
      "placeholder": "Enter Your Phone  * "
    },
    on: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h3', [_vm._v("This screening is for you, if you:")]), _vm._v(" "), _c('br'), _vm._v(" "), _vm._m(1), _vm._v(" "), _c('br'), _vm._v(" "), _c('br'), _vm._v(" "), _vm._m(2), _vm._v(" "), _c('br'), _vm._v(" "), _c('br'), _vm._v(" "), _c('br'), _vm._v(" "), _c('br'), _vm._v(" "), _c('router-link', {
  ...
  return _c('div', {
    staticClass: "row justify-content-center remove_margin"
  }, [_c('img', {
    attrs: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: "col-xl-2 col-md-4 col-sm-12 align_Nav_content"
  }, [(_vm.$store.state.showHotline) ? _c('a', {
    attrs: {
      "href": "#"
    }
    ...
    class: _vm.$store.state.showHotline ? 'col-md-2' : 'col-md-2'
  }, [_vm._m(4)]), _vm._v(" "), _c('div', {
    class: _vm.$store.state.showHotline ? 'col-md-10' : 'col-md-8'
  }, [_c('div', {
  ...
  return _c('span', {
    staticClass: "share col-xl-3 col-md-5 col-sm-12 align_Nav_content"
  }, [_c('strong', [_vm._v("Share with your family and friends")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "short_contact_list col-xl-2 col-md-3 col-sm-12 align_Nav_content"
  }, [_c('a', {
    staticClass: "share",
    attrs: {
  ...
  return _c('div', {
    staticClass: "social_media_links col-xl-2 col-md-5 col-sm-12 align_Nav_content"
  }, [_c('a', {
    attrs: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.advices[3].text))])])])])])])])])])])])])]), _vm._v(" "), _c('chatbot'), _vm._v(" "), _vm._m(5), _vm._v(" "), _vm._m(6)], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "row"
  }, [_c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "col-md-8 col-sm-12 login-module clint_Portal_Padding"
  }, [_c('div', {
    staticClass: "module-box"
  }, [_c('h1', {
    staticClass: "doctors_title mb-40 text-center"
  ...
  return _c('div', {
    ...
    staticClass: "justify-content-center col-md-12 col-xl-12"
  }, [_c('div', {
    staticClass: "card-body"
  }, [_c('div', {
    staticClass: "alert alert-success text-center",
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "text-center"
  }, [_vm._v("COVID19")]), _vm._v(" "), _c('b-table', {
    staticStyle: {
      "position": "relative"
    },
    attrs: {
      ...
      fn: function(row) {
        return [_c('VueLoadingButton', {
          ...
          attrs: {
            ...
            "disabled": _vm.isLoading && _vm.indexClicked === row.index,
            "styled": _vm.isStyled
          },
          nativeOn: {
            "click": function($event) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("COVID-19 Self-Checker")]), _vm._v(" "), (!_vm.stopAudio) ? _c('button', {
    ...
    }, [_vm._v("Yes")]) : _vm._e(), _vm._v(" "), (message.type == 'boolean') ? _c('button', {
      staticClass: "check",
      attrs: {
        "id": 'btn' + index,
        "name": "buttonRadio",
    ...
    }, [_vm._v("No")]) : _vm._e()], 1) : _vm._e()])])])
  }), 0), _vm._v(" "), _c('form', {
    staticClass: "sc-user-input"
  }, [(_vm.endDialog) ? _c('b-button', {
    staticClass: "btn btn-info newStyle center",
    on: {
      "click": _vm.reset
    }
  }, [_vm._v("Take Again")]) : _vm._e(), _vm._v(" "), (!_vm.endDialog) ? _c('div', {
  ...
  })]) : _vm._e(), _vm._v(" "), (!_vm.endDialog) ? _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })], 1) : _vm._e(), _vm._v(" "), _c('router-view')], 1), _vm._v(" "), _c('Footer')], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "row"
  }, [_vm._m(4), _vm._v(" "), _c('b-form-spinbutton', {
  ...
  return _c('div', {
    ...
    staticClass: "col-xl-4 col-md-4 col-sm-4"
  }, [_c('div', {
    staticClass: "single_service"
  }, [_c('img', {
    attrs: {
...
//# sourceMappingURL=app.bc50a34898f6f8851eda.js.map